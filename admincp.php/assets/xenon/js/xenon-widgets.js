    ...
    var setupWidgets = function() {
        ...
        $("[data-fill-from][data-fill-to]").each(function(i, el) {
            ...
            sm.fullyEnterViewport(function() {
                ...
                }, easing = attrDefault($el, "fill-easing", true), duration = attrDefault($el, "fill-duration", 2.5);
                if (easing) {
        ...
        $(".xe-status-update").each(function(i, el) {
            var $el = $(el), $nav = $el.find(".xe-nav a"), $status_list = $el.find(".xe-body li"), index = $status_list.filter(".active").index(), auto_switch = attrDefault($el, "auto-switch", 0), as_interval = 0;
            if (auto_switch > 0) {
            ...
            function goTo(plus_one) {
                ...
                var $to_hide = $status_list.filter(".active"), $to_show = $status_list.eq(index);
