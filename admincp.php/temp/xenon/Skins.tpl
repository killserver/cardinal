...
[foreach block=skin_list_admin]<option value="{skin_list_admin.skin}"[foreachif {skin_list_admin.selected}==true] selected="selected"[/foreachif {skin_list_admin.selected}==true]>{skin_list_admin.skin}</option>
[/foreach]</select></div>