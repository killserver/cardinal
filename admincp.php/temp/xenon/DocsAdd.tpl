	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			...
			<div class="panel-body">
				<form method="post" role="form" action="./?pages=DocsAdmin&mod=Take{typePage}" method="post" class="form-horizontal" enctype="multipart/form-data">
					...
					<div class="form-group">
						<label class="col-sm-2 control-label" for="field-2">{L_"Версия"}</label>
						<div class="col-sm-10">
							<input type="text" name="version" class="form-control" id="field-2" value="{version}">
						</div>
					</div>
					<div class="form-group">
...
if(typeof(editorTextarea)!="object") {
	var editorTextarea = {
		...
		plugins: [
			...
			"insertdatetime media table contextmenu paste imagetools responsivefilemanager codesample"
		],
		toolbar: "bold italic | alignleft aligncenter alignright alignjustify | bullist numlist outdent indent | link image responsivefilemanager codesample",
		content_css: [],
		valid_elements : "*[*]",
		forced_root_block : '',
		image_advtab: true, 
