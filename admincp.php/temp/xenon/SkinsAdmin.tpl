	...
	<div class="col-sm-12">
		<div class="panel panel-default">
			<div class="panel-body">
				<div class="row">
					[foreach block=skins]<a href="#" class="col-xs-12 col-md-6 col-lg-3[foreachif {skins.orName}!={C_skins[skins]}] install[/foreachif {skins.orName}!={C_skins[skins]}]" data-name="{skins.orName}">
						<div class="image">
...
<style type="text/css">
	...
	.panel div.image > .set { position: absolute; top: -100%; left: 0px; width: 100%; transition: all 300ms ease-in-out; background: #40bbea; padding: 10px 15px; color: #fff; font-size: 1.25rem; }
