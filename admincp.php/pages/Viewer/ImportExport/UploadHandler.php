...
class UploadHandler {
    ...
    public function __construct($options = null, $initialize = true, $error_messages = null) {
        $this->response = array();
        $dir = dirname(__FILE__).DS."uploads".DS;
        ...
        $this->options = array(
            'script_url' => $this->get_full_url().'/'.$this->basename($this->get_server_var('SCRIPT_NAME'))."?pages=ImportExport&upload=1",
            'upload_dir' => $dir,
            'upload_url' => get_site_path($dir),
            ...
            'readfile_chunk_size' => 1024 * 1024 * 1024, // 1000 MiB
