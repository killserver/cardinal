...
class Login_MainChange extends Login {
	...
	function __construct() {
		...
		if(file_exists(ROOT_PATH.(defined("ADMINCP_DIRECTORY") ? ADMINCP_DIRECTORY : "admincp.php")."/assets/".config::Select('skins','admincp')."/css/custom.css")) {
			$this->InsertList("CustomCssChange", config::Select("default_http_local").(defined("ADMINCP_DIRECTORY") ? ADMINCP_DIRECTORY : "admincp.php")."/assets/".config::Select('skins','admincp')."/css/custom.css?".time(), "css");
		}
		if(file_exists(ROOT_PATH.(defined("ADMINCP_DIRECTORY") ? ADMINCP_DIRECTORY : "admincp.php").DS."assets".DS.config::Select('skins','admincp')."/css".DS."login.css")) {
			...
			$this->InsertList("MainChange", config::Select("default_http_local").(defined("ADMINCP_DIRECTORY") ? ADMINCP_DIRECTORY : "admincp.php")."/assets/".config::Select('skins','admincp')."/css/login-default.css?4", "css");
		}
	}
