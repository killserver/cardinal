...
//users
    ...
    "recovery_step_1" => "Введите любую информацию о профиле, которую помните",
    "recovery_step_2" => "Введите почту пользователя",
    "recovery_step_3" => "Введите код-восстановления из письма",
    "recovery_step_4" => "Введите новый пароль для пользователя",
    "recovery_step_4_error" => "Ключ не найден в системе. Попробуйте ещё раз",
    "recovery_mail" => "Пользователь запросил восстановление доступов к учётной записи <b>{username}</b><br>\n<b>Время запроса:</b>{time}<br>\n<b>IP:</b>{ip}<br>\n<br>\nДля восстановления перейдите: <a href=\"{host}?recovery&key={key}\" target=\"_blank\">{host}?recovery&key={key}</a><br>\n<b>Или введите:</b> {key}",
));
