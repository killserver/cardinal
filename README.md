...
### Для работы в режиме фреймворка - создайте файл "isFrame.lock" в папке core/media/
Если Вам необходима работа с базой данных - переименуйте файл db.default.php в db.php и выполните настройку

### Для работы в режиме движка -  зайдите на сайт, где Вас перенаправит на страницу установки где будет выполнена полуавтоматическая установка.
